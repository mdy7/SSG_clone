package com.nocaffeine.ssgclone.domain.specialprice.vo.response;

import com.nocaffeine.ssgclone.domain.specialprice.dto.response.SpecialPriceProductIdResponseDto;
