...
import com.nocaffeine.ssgclone.domain.product.application.TotalService;
import com.nocaffeine.ssgclone.domain.product.dto.response.total.ProductTotalResponseDto;
import com.nocaffeine.ssgclone.domain.product.vo.response.total.ProductTotalResponseVo;
