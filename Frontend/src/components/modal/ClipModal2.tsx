...
export default function ClipModal({ closeModal }: any) {
    ...
    return (
        <>
            ...
            <div className={`w-full h-[314.8px] transform ${animate ? 'translate-y-0' : 'translate-y-full'} absolute bottom-0 font-sans transition-transform ease-out duration-500 z-40 bg-white rounded-lg`}>
                ...
                <div className='flex-col items-center justify-center'>
                    ...
                    <div className='py-[30px] flex justify-center'>
                        <button className='w-[96px] h-11 rounded-full px-[27px] text-[14px] whitespace-nowrap border-gray-500 border-[1.5px]' 
                        onClick={async () => {
                            closeModal();
                        }}>닫기</button>
                    </div>
